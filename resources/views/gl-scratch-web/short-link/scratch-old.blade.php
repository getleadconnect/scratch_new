    ...
    <div id="carouselExampleIndicators" class="carousel slide desktop" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block img-fluid" src="{{ Storage::disk('s3')->url($offer->vchr_scratch_offers_image) }}" alt="First slide">
        </div>        
      </div>
...
{{-- <div id="carouselExampleIndicators" class="carousel slide mob" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block img-fluid" src="{{url('glscratch-web/assetsold/media/logos/slidem1.png')}}" alt="First slide">
        </div>
        <div class="carousel-item">
          <img class="d-block img-fluid" src="{{url('glscratch-web/assetsold/media/logos/slide2m.png')}}" alt="Second slide">
        </div>
 ...
 <div class="kt-login__signin">
        ...
        <div class="kt-login__head"> 
          <h3 class="kt-login__title">
            ...
            <div class="kt-login__desc">Enter your email ID and password to get access
              to your account</div>
              <div class="kt-login__actions">
                <button id="kt_login_signup" class="btn btn-pill kt-login__btn-primary">Get my scratch card</button>
                &nbsp;&nbsp; </div>
           
         {{-- <div class="kt-login__logo "> <a href="javascript:;" class="kt-link kt-link--light kt-login__account-link"> <img src="{{url('glscratch-web/assetsold/media/logos/brand.png')}}" class="img-fluid"> </a> </div> --}}
           
          <a href="#" style="text-align: center;display: block;margin-top: 10px;font-size: 12px;color:#ccc" data-toggle="modal" data-target="#exampleModalCenter">Terms & conditions</a> </div>
      </div>
      {{-- //*page 1 END --}}
      ...
      <div class="kt-login__signup">
        <div class="kt-login__head">
          <h3 class="kt-login__title">Find your 
            Digital scratch card</h3>
          <div class="kt-login__desc">Enter your email ID and password to get access
            to your account</div>
        </div>
        <form class="kt-login__form kt-form" action="" id="details-page">
          ...
          <div class="row" style="padding-left: 10px; padding-right: 10px;">
            ...
            <div class="col-3 input-group">
              ...
              <select class="form-control " id="country_code_id" name="country_code"  autocomplete="off">
    ...
    <div class="kt-login__otp">
      <div class="kt-login__head">
        ...
        <div class="kt-login__desc">Enter the verification code that we sent to your
          mobile number <b>+919447752786</b></div>
      </div>
      <form class="kt-login__form kt-form" action="">
        <div class="input-group">
          <label>OTP</label>
          <input class="form-control" type="password" placeholder="Enter OTP" name="mobile number" autocomplete="off">
        </div>               
        <div class="kt-login__actions">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function glScrtachView(offerListing) {
                ...
                var promoCode = '';
                //   var bg4 = "{{url('glscratch-web/assetsold/media/logos/banglore-pub/beer.png')}}";
                //   var bg5 = "{{url('glscratch-web/assetsold/media/logos/banglore-pub/trimmer.png')}}";
                //   var bg1 = "{{url('glscratch-web/assetsold/media/logos/gift-2.png')}}";
                var bg3 = "{{url('glscratch-web/assetsold/media/logos/tt-betterluck.png')}}";
                ...
                $('#promo').wScratchPad({
                    ...
                    realtime: true,
                    // The overlay image
                    // fg: "{{url('glscratch-web/assetsold/media/logos/tt-scratchhere.png')}}",

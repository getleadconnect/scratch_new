...
<div class="kt-grid kt-grid--ver kt-grid--root kt-page">
    <div class="kt-grid kt-grid--hor kt-grid--root kt-login kt-login--v2 kt-login--signin" id="kt_login">
      <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor"
        style="background-image: url({{url('glscratch-web/assets/media//bg/bg-1.jpg')}});">
            ...
            <div class="kt-login__logo">
                <a href="#"> 
                  @if($offer->vchr_scratch_offers_image)              
                    ...
                    <img src="{{  Storage::disk('s3')->url($offer->vchr_scratch_offers_image) }}" /> 
                  @elseif($user->vchr_logo)
                    <img src="{{ Storage::disk('s3')->url('uploads/user-profile/' . $user->vchr_logo) }}" style="width: 300px; height: 100px"/> 
                  @else
                      <img src="{{url('glscratch-web/assets/media/logos/logo-mini-2-md.png')}}" style="width: 300px; height: 100px"/> 
                  @endif
                </a> 
            </div>
            <div class="kt-login__signin">
              <div class="kt-login__head">
                <h2 class="kt-login__title" style="font-size: 28px;font-weight: bold">{{$offer->vchr_scratch_offers_name}}</h2>
                <div class="kt-login__logo "> <a href="javascript:;" id="kt_login_signup"
                    class="kt-link kt-link--light kt-login__account-link"> <img
                      src="{{url('glscratch-web/assets/media/logos/lock-scratch.png')}}"> </a> </div>

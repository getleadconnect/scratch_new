            ...
            <!--end breadcrumb-->
              ...
              <div class="card">
					...
					<div class="accordion-item accordion-item-bm" >
                        <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample" >
                         <div class="accordion-body">
						  ...
						  <form method="POST" id="export_redeem_history"  action="{{url('shops/export-web-customers-list')}}" enctype="multipart/form-data" >
							@csrf 
				...
				<div class="row mt-3">
					 ...
					 <label>Total Customers : <span style="font-weight:600;" id="web_count"></span></label>
					 </div>
				</div>
...
var table1 = $('#datatable').DataTable({
		...
		ajax:
		{
			url:BASE_URL+"/shops/get-customers-history",
			data: function (data) 
		    {

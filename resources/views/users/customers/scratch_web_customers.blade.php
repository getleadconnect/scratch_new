              ...
              <div class="card">
				...
				<div class="col-lg-9 col-xl-9 col-xxl-9 col-9">
				  ...
				  <div class="col-lg-3 col-xl-3 col-xxl-3 col-3 text-right">
				     <a href="javascript:;" class="btn btn-gl-primary" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" ><i class="lni lni-funnel"></i>&nbsp;Filter</a>
				  </div>
				  </div>
                </div>
                <div class="card-body">
					...
					<div class="accordion-item accordion-item-bm" >
                        <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample" >
						 ...
						 <form method="POST" id="export_redeem_history"  action="{{url('users/export-web-customers-list')}}" enctype="multipart/form-data" >
							@csrf 
						  <label style="font-weight:500;padding:5px 10px;" > Export Data By: </label>
...
var table = $('#datatable').DataTable({
		...
		columns: [
		   ...
		   {data: 'redeemed_agent', name: 'redeemed_agent'},

...
jQuery.validator.addMethod("specialChars", function(value, element) {
    // Regular expression to match special characters except "@"
    var regex = /^[^*/_=^~#%&$!<>\s+-]+$/;
...
/* Event for login button submit */
    // $('#kt_sigup_submit').on('click', function (e) {
    //     form = $("#kt_sigup_signin_form");
...
jQuery(document).ready(function() {
  ...
  (function ($, rulesEngine) {
    ...
    //       if (word.match(/^([\w\!\#$\%\&\'\*\+\-\/\=\?\^\`{\|\}\~]+\.)+@((((([a-z0-9]{1}[a-z0-9\-]{0,62}[a-z0-9]{1})|[a-z])\.)+[a-z]{2,6})|(\d{1,3}\.){3}\d{1,3}(\:\d{1,5})?)$/i)) {
    //           return score;
    //       }
    //       return 0;
    //   };
  ...
  defaultOptions.ui.errorMessages = {
      wordLength: "Please enter at least 6 characters",
      ...
      wordLowercase :"Password must contain lowercase letter",
      wordUppercase:"Password must contain uppercase letter",
      wordOneNumber:"Password must contain one number",
      wordOneSpecialChar:"Password must contain one special character",

...
//Route::post('/logout', [GetleadScratchController::class, 'logout'])->middleware('auth:api');
//Route::post('/register', [GetleadScratchController::class, 'register']);
//Route::post('/refresh', [GetleadScratchController::class, 'refresh'])->middleware('auth:api');
//Route::post('/profile', [GetleadScratchController::class, 'profile'])->middleware('auth:api');
